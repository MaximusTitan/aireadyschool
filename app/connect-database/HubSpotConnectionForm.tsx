  ...
  const handleConnect = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("/api/connect-hubspot", {
        ...
        body: JSON.stringify({ hubspotAccessToken: accessToken, crmName }),
      })
      ...
      if (result.success) {
        ...
        setConnectionStatus({ success: false, message: result.error || "Failed to connect to HubSpot" })
      }
    } catch (error) {
  ...
  return (
    <Card className="max-w-md mx-auto">
      <CardHeader>
        ...
        <CardDescription>Enter your HubSpot Private App Access Token to connect.</CardDescription>
      </CardHeader>
