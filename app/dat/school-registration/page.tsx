...
const educationBoards = ["CBSE", "ICSE", "State Board", "IB", "IGCSE", "Other"];
...
export default function SchoolRegistration() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(
        `/dat/thankyou?school=${encodeURIComponent(formData.schoolName)}`
      );
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-white py-12">
      <div className="max-w-3xl mx-auto p-6 bg-white shadow-sm">
        ...
        <h1 className="text-2xl font-bold mb-2 text-left text-[#e42467]">
          School Registration
        </h1>
        <p className="text-gray-600 text-left mb-6">
          Register your school to join our AI Ready School program
        </p>
