...
import { Loader2, Video, Users, Clock } from "lucide-react";
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Select value={videoType} onValueChange={setVideoType}>
              ...
              <SelectContent>
                <SelectItem value="promotional">School Promotional</SelectItem>
          ...
          <div className="relative">
            ...
            <Select name="targetAudience" defaultValue="parents">
              ...
              <SelectContent>
                ...
                <SelectItem value="students">Prospective Students</SelectItem>
