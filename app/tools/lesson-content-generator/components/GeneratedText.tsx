...
const Heading1: React.FC<HeadingProps> = ({ children, ...props }) => (
  <h1
    className="text-2xl font-semibold leading-none tracking-tight mb-4"
    {...props}
  >
    {children}
  </h1>
...
const Heading2: React.FC<HeadingProps> = ({ children, ...props }) => (
  <h2
    className="text-xl font-semibold leading-none tracking-tight mb-3"
    {...props}
  >
    {children}
  </h2>
...
const Heading4: React.FC<HeadingProps> = ({ children, ...props }) => (
  <h4
    className="text-base font-semibold leading-none tracking-tight mb-2"
    {...props}
  >
    {children}
  </h4>
