...
import { CheckCircle2, AlertTriangle, Clock, BookOpen, ClipboardList, BarChart } from "lucide-react"
...
const supabase = getSupabaseClient()
      ...
      <CardContent>
        {assessments.map((assessment, index) => (
          <div key={index} className="mb-4 last:mb-0">
            ...
            <p className="text-sm text-gray-600 mb-2">Topic: {assessment.topic}</p>
      ...
      <CardContent>
        {strategies.map((strategy, index) => (
          <div key={index} className="mb-4 last:mb-0">
            ...
            <p className="text-sm font-medium text-gray-600 mb-1">{strategy.strategy}</p>
  ...
  const isPlaceholder = (day: Day) => day.topicHeading.startsWith("Placeholder for Day")
            ...
            <CardContent className="p-6">
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <p className="text-yellow-700">
                  This day's content is a placeholder. The AI was unable to generate complete content for this day.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <p className="text-sm text-green-700 mb-2">By the end of this session, students will be able to:</p>
              ...
              <Card>
                ...
                <CardContent>
                  {selectedDay.assignment.description && (
                    <p className="mb-2 font-semibold">{selectedDay.assignment.description}</p>
                  )}
                  {selectedDay.assignment.tasks && selectedDay.assignment.tasks.length > 0 && (
                    <ul className="list-disc pl-5">
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6">Lesson Plan Output</h1>
        ...
        <CardContent>
          <Table>
            ...
            <TableBody>
              ...
              <TableRow>
                <TableCell className="font-medium">Learning Objectives</TableCell>
          ...
          {lessonPlan.plan_data.days && lessonPlan.plan_data.days.length > 0 ? (
            lessonPlan.plan_data.days.map((day) => (
              ...
              >
                ...
                {isPlaceholder(day) && <AlertTriangle className="ml-2 h-4 w-4" />}
              </Button>
            ))
          ) : (
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          {lessonPlan.plan_data.assessmentPlan ? (
            <>
              {renderAssessments(lessonPlan.plan_data.assessmentPlan.formativeAssessments, "Formative Assessments")}
              {renderAssessments(lessonPlan.plan_data.assessmentPlan.summativeAssessments, "Summative Assessments")}
              <Card>
                <CardHeader>
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          {lessonPlan.plan_data.remedialStrategies && lessonPlan.plan_data.remedialStrategies.length > 0 ? (
