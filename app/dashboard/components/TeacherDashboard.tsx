...
function QuickAccessTool({
  ...
  return (
    ...
    >
      ...
      <div>
        <h3 className="font-medium text-gray-700 group-hover:text-primary">
          {title}
        </h3>
...
export default function TeacherDashboard() {
  ...
  if (!teacherData || !schoolData) {
    return (
      <div>No teacher data found. Please complete your profile setup.</div>
    );
  }
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-500 mt-1">
                Have a productive day teaching!
              </p>
            </div>
            <Notifications />
          </div>
