...
import styles from "../styles/research-assistant.module.css";
        ...
        <div className="max-w-6xl mx-auto flex flex-col h-full p-4 shadow-lg rounded-lg overflow-hidden border border-black">
          <div className="flex-1 overflow-y-auto">
            <div className="flex flex-col w-full">
              {error && (
                <Alert variant="destructive" className={styles.animateSlideIn}>
                                  ...
                                  a: ({ node, href, children, ...props }) => {
                                    ...
                                    return (
                                      <a
                                        {...props}
                                        href={href}
                                        target={isCitation ? "_self" : "_blank"}
                                        rel={
                                          isCitation
                                            ? ""
                                            : "noopener noreferrer"
                                ...
                                <div className="absolute top-2 right-2 flex space-x-2">
                                  <DropdownMenu>
                                    ...
                                    >
                                      <DropdownMenuItem
                                        onClick={() =>
                                          handleDownload("pdf", message.content)
                                        }
